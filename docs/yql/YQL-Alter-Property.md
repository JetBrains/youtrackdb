...
| `COLLATE` | String | Sets collate to one of the defined comparison strategies.  By default, it uses the case-sensitive (`default`) strategy. You can also set it to case-insensitive (`ci`).                                                                                                                                                                                                                     |
