...
| property&lt;indexes&gt;             | Record property part.                                                                                        |where tags[name='Hi'] or tags[0-3] IN ('Hello') and employees IS NOT NULL|
...
| [functions](YQL-Functions.md)       | Any [function](YQL-Functions.md) between the defined ones                                                    |where distance(x, y, 52.20472, 0.14056 ) <= 30|
...
|@class| returns Class name                                                                                                                                                                                                                                                        |**@class** = 'Profile'|
...
|string|CONTAINSTEXT| A simple Java indexOf will be performed.                                                                                                                                                                                                                                                                                                                                                                                                                                                  | text *containsText* 'vika'                                                        |
...
|NOT|true if the condition is false. NOT needs parentheses on the right with the condition to negate|**not** ( name = 'Luke')|
...
Also called "Property Operators", these are [treated on a separate page](YQL-Methods.md).

## Functions

All the [YQL functions are treated on a separate page](YQL-Functions.md).
...
To set custom variable use the [LET](YQL-Query.md#let-block) keyword.