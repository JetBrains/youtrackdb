...
You now have the whole shape. You know the five phases and the rule that each runs in its own session ([Chapter 1](01-workflow-at-a-glance.md)), you have watched a minimal change run end to end ([Chapter 2](02-minimal-change-end-to-end.md)), and you can place your own change in a tier ([Chapter 3](03-tiers-and-the-tier-gate.md)). You know how research becomes a frozen design and a derived plan (Chapters [4](04-phase-0-research.md) through [6](06-phase-1-plan-and-tracks.md)), how the phase ledger resumes a cleared session ([Chapter 7](07-phases-sessions-phase-ledger.md)), and how a plan clears review before any code is written ([Chapter 8](08-phase-2-plan-review.md)). You can decompose a track into steps, drive the implement-test-commit loop, and read a dimensional review report (Chapters [9](09-phase-a-decomposition.md) through [12](12-phase-c-track-review-completion.md)). And you know what survives the merge, how the workflow handles a change that goes wrong mid-flight, and how a long-lived branch stays current with a workflow that keeps moving under it (Chapters [13](13-phase-4-final-artifacts.md) through [15](15-drift-and-migration.md)). The last thing left is to run a change yourself. Pick a small one, take the minimal tier, and start the loop. The workflow, and this book with it, will improve from what you find.
