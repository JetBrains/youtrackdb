...
| [Internal Documentation](../docs-internal/README.md) | Contributor- and agent-facing documentation — development workflow, role guidelines, and the Architecture Decision Record archive |
