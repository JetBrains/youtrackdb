...
- **`track-code-review.md`** — `## Agent selection and launching` (`:480`) selects agents per `review-agent-selection.md` and dispatches them against the cumulative track diff at Phase C. This is the track-level dispatch point.
