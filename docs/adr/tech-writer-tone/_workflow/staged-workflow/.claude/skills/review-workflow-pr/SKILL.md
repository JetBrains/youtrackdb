...
- `.claude/workflow/design-document-rules.md` when the reviewer asks whether a design section has the right shape (`### Summary`, mechanism overview, edge cases, References footer).
