...
The default LLM register is verbose, hedging, list-heavy, and full of "AI tells" (throat-clearing, padding analysis). Documents in this register are slow to read and reviewers ignore them. Use the **House Style** output style at `.claude/output-styles/house-style.md` whenever you draft:
