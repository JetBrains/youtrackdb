...
- **String references to update (12 total across 5 files):** `CLAUDE.md:93,102`, `.claude/skills/code-review/SKILL.md:313`, `.claude/agents/review-workflow-consistency.md:72`, `.claude/agents/review-workflow-writing-style.md:3,7,9,11,13,26,62,102,137`, and the source file itself (frontmatter `name:`). Full table in `design.md § Rename: every reference site across the repo`.
...
4. Updated string references across the four companion files listed above.
...
3. **Find-and-replace sweep.** Update the 12 string references across `CLAUDE.md`, `.claude/skills/code-review/SKILL.md`, `.claude/agents/review-workflow-consistency.md`, and `.claude/agents/review-workflow-writing-style.md`. Each is a single-line edit; use the table in `design.md § Rename: every reference site across the repo` as the authoritative checklist. Where the source text says "concise-doc style" or "**concise-doc**" with markdown emphasis, preserve the emphasis style on the replacement.
