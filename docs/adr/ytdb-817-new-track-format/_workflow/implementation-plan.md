...
- [ ] Track 3: Update writer SKILLs (`/create-plan`, `/review-plan`, inline-replanning, track-skip)
  ...
  > **Scope:** ~4 steps covering `create-plan/SKILL.md`, `review-plan/SKILL.md`, `inline-replanning.md` (cases 2–6), and `track-skip.md`. The writer-rewrite portion (formerly the 5th step) has moved to Track 2's atomic shape switch per D13; `inline-replanning.md` case 1 has already landed in Track 2 (WI3) and is not in Track 3 scope.
  > **Depends on:** Track 2
