...
| §`design.md` is frozen — Phase 2 does not mutate it | orchestrator,reviewer-design | 2 | design.md is frozen after Phase 1; Phase 2 records design-touching findings and defers the design.md correction to Phase 4; plan/track fixes still use Edit. |
...
<!-- roles=orchestrator,reviewer-design phases=2 summary="design.md is frozen after Phase 1, so Phase 2 records design-touching findings and defers the design.md correction to Phase 4; plan/track fixes still use Edit." -->
