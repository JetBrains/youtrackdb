...
**PAUSED 2026-05-31 mid inline-replan (Track 5) — plan/track edits applied; pending the `edit-design` design.md mutation + structural preview + final replan commit**
