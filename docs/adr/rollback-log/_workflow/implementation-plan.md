...
Track summaries are intentionally short. Per-track edit lists, file/line citations, and step ordering live in `implementation-backlog.md` (loaded on demand by `/execute-tracks`).
