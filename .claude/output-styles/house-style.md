...
7. **Structure.** Section length ≤200 words. No faux-symmetry. No bullet-everything. No inline-header lists outside genuine definition lists. Sentence case on H2+. No skipped heading levels. No fragmented headers (heading + ≤1-line paragraph with ≥50% content-word overlap).
