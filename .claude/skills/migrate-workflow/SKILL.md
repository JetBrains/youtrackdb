...
Auto-detection runs in `/execute-tracks` startup via [`workflow-drift-check.md`](../../workflow/workflow-drift-check.md); manual invocation of this skill stays the migration entry point.
