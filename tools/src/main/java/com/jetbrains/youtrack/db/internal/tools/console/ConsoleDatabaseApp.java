...
//      youTrackDB = (YouTrackDBAbstract<?, ?>)
//          YourTracks.remote(urlConnection.getType() + ":" + urlConnection.getPath(), iUserName,
//              iUserPassword, YouTrackDBConfig.defaultConfig());
//    } else {
//      youTrackDB = (YouTrackDBAbstract<?, ?>)
//          YourTracks.embedded(urlConnection.getPath(), YouTrackDBConfig.defaultConfig());
//    }
//
...
//    } else {
//      youTrackDB =
//          new YouTrackDBAbstract(conn, currentDatabaseUserName, currentDatabaseUserPassword,
//              config.build());
//    }
//
...
//      value =
//          ((YouTrackDBInternalRemote) YouTrackDBInternal.extract(youTrackDB))
...
//    }
//
//    youTrackDB = new YouTrackDBAbstract(url, user, pw, YouTrackDBConfig.defaultConfig());
//    return RESULT.OK;
//  }
//
//  /**
