...
import com.jetbrains.youtrackdb.internal.core.gremlin.gremlintest.YTDBGraphInitUtil;
...
public class EmbeddedGraphFeatureTest {
  ...
  public static class EmbeddedGraphWorld implements World {
    ...
    private static String getWorkingDirectory() {
      return TestHelper.makeTestDataDirectory(
          EmbeddedGraphFeatureTest.class, "graph-provider-data");
    }
  }
