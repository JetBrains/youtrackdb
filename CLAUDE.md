...
- **Git**: Not in version control (regenerated from grammar on every build)
- **Editing**: Never edit generated parser files directly
...
- **Git**: **Committed to version control** (regenerated only when `@GremlinDsl` interfaces change)
- **Editing**: Never edit generated parser files directly
...
- Qodana excludes generated SQL parser (`core/.../sql/parser/`) code from analysis and ANTLR (`core/src/main/generated/java/antlr/`)
...
3. **Generated code**:
   - **Never edit**: SQL parser (`core/.../sql/parser/`), ANTLR files (`core/src/main/generated/java/antlr/`)
   - **Committed to git**: Gremlin DSL (`core/src/main/generated/java/gremlin/`) - edit `@GremlinDsl` interfaces to regenerate
