...
public class ColumnSecurityTest {
  ...
  public void testReadFilterOneProperty() {
    ...
    session.close();
    this.session = (DatabaseSessionEmbedded) youTrackDB.open(DB_NAME, "reader", "reader");
    session.begin();
  ...
  public void testCreate() {
    ...
    session.close();
    this.session = (DatabaseSessionEmbedded) youTrackDB.open(DB_NAME, "writer", "writer");
  ...
  public void testReadHiddenColumn() {
    ...
    session = (DatabaseSessionEmbedded) youTrackDB.open(DB_NAME, "reader", "reader");
    session.begin();
