...
/**
 * Unit tests for {@link VertexStepRecogniser}, the recogniser that claims a folded bare vertex hop
...
public class VertexStepRecogniserTest extends GraphBaseTest {
  ...
  /**
   * A non-{@link VertexStep} (defence-in-depth against a future registry mistake) declines cleanly
   * rather than throwing {@code ClassCastException}. The start {@code GraphStep} at index 0 is fed to
