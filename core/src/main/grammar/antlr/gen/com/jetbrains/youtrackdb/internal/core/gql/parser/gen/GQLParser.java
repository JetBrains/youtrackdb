...
public class GQLParser extends Parser {
	...
	public static final int
		...
		DIV=85, MOD=86, BOOL=87, DOT=88, DASH=89, ID=90, NUMBER=91, INT=92, STRING=93, 
		WS=94;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"DOT", "DASH", "ID", "NUMBER", "INT", "STRING", "WS"
		};
	}
	...
	public final Return_statmentContext return_statment() throws RecognitionException {
		...
		try {
			...
			case STRING:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -139611588448485238L) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 96469247L) != 0)) {
					{
					setState(307);
					return_items();
					}
