...
public class YTDBGraphTraversalSource extends YTDBGraphTraversalSourceDSL {
  ...
  @Override
  public YTDBGraphTraversal<Object, Object> gql(String query) {
    YTDBGraphTraversalSource clone = this.clone();
    return new DefaultYTDBGraphTraversal (clone, super.gql(query).asAdmin());
  }

  @Override
  public YTDBGraphTraversal<Object, Object> gql(String query, Map<?, ?> arguments) {
    YTDBGraphTraversalSource clone = this.clone();
    return new DefaultYTDBGraphTraversal (clone, super.gql(query,arguments).asAdmin());
  }
