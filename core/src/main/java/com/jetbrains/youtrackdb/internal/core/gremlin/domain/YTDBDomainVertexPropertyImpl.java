...
public class YTDBDomainVertexPropertyImpl<T extends YTDBDomainVertex, V> implements
    VertexProperty<V> {
  private final @Nonnull T domainObject;
  private final @Nonnull YTDBPTokenInternal<T> pToken;
  private YTDBVertexPropertyId id;

  public YTDBDomainVertexPropertyImpl(@Nonnull T domainObject,
      @Nonnull YTDBPTokenInternal<T> pToken) {
