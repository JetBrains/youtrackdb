...
public class SQLFromItem extends SimpleNode {
  ...
  @Nullable
  public ImmutableSchemaClass getSchemaClass(DatabaseSessionEmbedded session) {
    if (identifier == null) {
      return null;
    }
    ...
    if (stringValue != null && !stringValue.isEmpty()) {
      return session.getMetadata().getFastImmutableSchemaSnapshot().getClass(stringValue);
    }
