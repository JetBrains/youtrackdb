...
public abstract class YTDBAbstractElement implements YTDBElement {

  protected YTDBGraphInternal graph;
  protected final RID rid;

  public YTDBAbstractElement(final YTDBGraphInternal graph, final Entity rawEntity) {
    if (rawEntity == null) {
  ...
  public <V> Property<V> property(final String key, final V value) {
    ...
    if (value instanceof YTDBAbstractElement ytDBElement) {
