...
/// represent the [com.jetbrains.youtrack.db.api.schema.PropertyType#EMBEDDEDLIST] type.
///
...
///
/// If an embedded list is associated with [com.jetbrains.youtrack.db.api.record.Entity] it cannot
/// contain links to another record. This restriction is forced because a database always ensures
/// links consistency.
///
/// If an embedded list is associated with [com.jetbrains.youtrack.db.api.record.Entity] it can
...
///
/// @see com.jetbrains.youtrack.db.api.common.query.BasicResult#getEmbeddedList(String)
