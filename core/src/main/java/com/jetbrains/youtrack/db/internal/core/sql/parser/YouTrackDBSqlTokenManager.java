...
private int jjMoveStringLiteralDfa0_0()
{
   switch(curChar)
   {
      ...
      case 38:
         jjmatchedKind = 214;
         return jjMoveStringLiteralDfa1_0(0x0L, 0x100008000L, 0x0L);
      case 40:
      ...
      case 45:
         jjmatchedKind = 211;
         return jjMoveStringLiteralDfa1_0(0x0L, 0x20020000L, 0x0L);
      case 46:
         jjmatchedKind = 190;
         return jjMoveStringLiteralDfa1_0(0x0L, 0x60000000000L, 0x0L);
      case 47:
         jjmatchedKind = 213;
         return jjMoveStringLiteralDfa1_0(0x80L, 0x80000000L, 0x0L);
      case 58:
      ...
      case 60:
         jjmatchedKind = 196;
         return jjMoveStringLiteralDfa1_0(0x0L, 0x1008002400L, 0x0L);
      case 61:
         jjmatchedKind = 194;
         return jjMoveStringLiteralDfa1_0(0x0L, 0x8L, 0x0L);
      case 62:
         jjmatchedKind = 197;
         return jjMoveStringLiteralDfa1_0(0x0L, 0x1e000000800L, 0x0L);
      case 63:
         jjmatchedKind = 200;
         return jjMoveStringLiteralDfa1_0(0x0L, 0x800000L, 0x0L);
      case 64:
         return jjStartNfaWithStates_0(0, 191, 1042);
      case 91:
      ...
      case 124:
         jjmatchedKind = 216;
         return jjMoveStringLiteralDfa1_0(0x0L, 0x200004000L, 0x0L);
      case 125:
...
private int jjMoveStringLiteralDfa1_0(long active0, long active3, long active4)
{
   ...
   switch(curChar)
   {
      ...
      case 60:
         ...
         return jjMoveStringLiteralDfa2_0(active0, 0L, active3, 0x1000000000L, active4, 0L);
      case 61:
         if ((active3 & 0x8L) != 0L)
      ...
      case 62:
         ...
         return jjMoveStringLiteralDfa2_0(active0, 0L, active3, 0x16000000000L, active4, 0L);
      case 63:
         if ((active3 & 0x800000L) != 0L)
            return jjStopAtPos(1, 215);
         break;
      case 95:
         return jjMoveStringLiteralDfa2_0(active0, 0L, active3, 0L, active4, 0x40L);
      case 124:
...
private int jjMoveStringLiteralDfa2_0(long old0, long active0, long old3, long active3, long old4, long active4)
{
   ...
   switch(curChar)
   {
      ...
      case 62:
         ...
         return jjMoveStringLiteralDfa3_0(active3, 0x4000000000L, active4, 0L);
      case 64:
         return jjMoveStringLiteralDfa3_0(active3, 0L, active4, 0x40L);
      default :
         break;
   }
...
private int jjMoveStringLiteralDfa3_0(long old3, long active3, long old4, long active4)
{
   ...
   switch(curChar)
   {
      case 61:
         ...
         break;
      case 114:
         return jjMoveStringLiteralDfa4_0(active3, 0L, active4, 0x40L);
      default :
         break;
   }
...
private int jjMoveStringLiteralDfa4_0(long old3, long active3, long old4, long active4)
{
   ...
   {
      case 101:
         return jjMoveStringLiteralDfa5_0(active4, 0x40L);
      default :
         break;
   }
...
private int jjMoveStringLiteralDfa5_0(long old4, long active4)
{
   ...
   {
      case 99:
         return jjMoveStringLiteralDfa6_0(active4, 0x40L);
      default :
         break;
   }
...
private int jjMoveStringLiteralDfa6_0(long old4, long active4)
{
   ...
   {
      case 111:
         return jjMoveStringLiteralDfa7_0(active4, 0x40L);
      default :
         break;
   }
...
private int jjMoveStringLiteralDfa7_0(long old4, long active4)
{
   ...
   {
      case 114:
         return jjMoveStringLiteralDfa8_0(active4, 0x40L);
      default :
         break;
   }
...
private int jjMoveStringLiteralDfa8_0(long old4, long active4)
{
   ...
   {
      case 100:
         return jjMoveStringLiteralDfa9_0(active4, 0x40L);
      default :
         break;
   }
...
private int jjMoveStringLiteralDfa9_0(long old4, long active4)
{
   ...
   {
      case 109:
         return jjMoveStringLiteralDfa10_0(active4, 0x40L);
      default :
         break;
   }
...
private int jjMoveStringLiteralDfa10_0(long old4, long active4)
{
   ...
   {
      case 97:
         return jjMoveStringLiteralDfa11_0(active4, 0x40L);
      default :
         break;
   }
...
private int jjMoveStringLiteralDfa11_0(long old4, long active4)
{
   ...
   {
      case 112:
         return jjMoveStringLiteralDfa12_0(active4, 0x40L);
      default :
         break;
   }
...
private int jjMoveStringLiteralDfa12_0(long old4, long active4)
{
   ...
   {
      case 64:
         return jjMoveStringLiteralDfa13_0(active4, 0x40L);
      default :
         break;
   }
...
private int jjMoveStringLiteralDfa13_0(long old4, long active4)
{
   ...
   {
      case 95:
         return jjMoveStringLiteralDfa14_0(active4, 0x40L);
      default :
         break;
   }
...
private int jjMoveStringLiteralDfa14_0(long old4, long active4)
{
   ...
   {
      case 95:
         return jjMoveStringLiteralDfa15_0(active4, 0x40L);
      default :
         break;
   }
...
private int jjMoveNfa_0(int startState, int curPos)
{
   ...
   for (;;)
   {
      ...
      if (curChar < 64)
      {
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 1096:
                  if (curChar == 45)
                     jjCheckNAddTwoStates(1097, 1100);
                  break;
               case 1097:
                  if ((0x3fe000000000000L & l) == 0L)
                     break;
               ...
               case 1102:
                  ...
                  if (kind > 178)
                     kind = 178;
                  jjCheckNAddTwoStates(1102, 1099);
                  break;
               case 1103:
                  if ((0xff000000000000L & l) == 0L)
                     break;
                  if (kind > 178)
                     kind = 178;
                  jjCheckNAddTwoStates(1103, 1099);
                  break;
               case 1104:
                  if (curChar == 46)
               ...
               case 1108:
                  if (curChar == 45)
                     jjCheckNAddTwoStates(1109, 1112);
                  break;
               case 1109:
                  if ((0x3fe000000000000L & l) == 0L)
                     break;
               ...
               case 1114:
                  ...
                  if (kind > 179)
                     kind = 179;
                  jjCheckNAddTwoStates(1114, 1111);
                  break;
               case 1115:
                  if ((0xff000000000000L & l) == 0L)
                     break;
                  if (kind > 179)
                     kind = 179;
                  jjCheckNAddTwoStates(1115, 1111);
                  break;
               case 1116:
                  if (curChar == 46)
               ...
               case 1123:
                  if ((0xff000000000000L & l) != 0L)
                     jjCheckNAddTwoStates(1124, 1120);
                  break;
               case 1124:
                  if ((0xff000000000000L & l) != 0L)
                     jjCheckNAdd(1120);
               ...
               case 1148:
                  ...
                  if (kind > 167)
                     kind = 167;
                  jjCheckNAddTwoStates(1148, 1092);
                  break;
               case 1149:
                  if ((0xff000000000000L & l) == 0L)
                     break;
                  if (kind > 167)
                     kind = 167;
                  jjCheckNAddTwoStates(1149, 1092);
                  break;
               case 1151:
                  if ((0x3ff000000000000L & l) != 0L)
                     jjAddStates(112, 113);
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 533:
                  ...
                  break;
               case 534:
                  if ((0x4000000040000L & l) != 0L && kind > 249)
                     kind = 249;
                  break;
               case 535:
                  if ((0x100000001000L & l) != 0L)
               ...
               case 549:
                  ...
                  break;
               case 553:
                  if ((0x100000001000L & l) != 0L && kind > 257)
                     kind = 257;
                  break;
               case 555:
                  if ((0x100000001000000L & l) != 0L)
      ...
      ++curPos;
      if ((i = jjnewStateCnt) == (startsAt = 1163 - (jjnewStateCnt = startsAt)))
         return curPos;
      try { curChar = input_stream.readChar(); }
...
static final int[] jjnextStates = {
   54, 55, 17, 58, 59, 62, 63, 1136, 1137, 1138, 1142, 1119, 1121, 1127, 1128, 1130, 
   19, 20, 22, 1091, 1092, 1093, 1094, 1104, 1105, 1106, 1117, 1147, 1149, 1092, 1150, 1157, 
   1143, 1145, 1094, 1104, 1139, 1141, 1106, 1117, 33, 35, 36, 1105, 1106, 1117, 1143, 1145, 
   1094, 1104, 1093, 1094, 1104, 1139, 1141, 1106, 1117, 13, 14, 17, 19, 20, 24, 22, 
   54, 55, 17, 64, 65, 17, 327, 308, 362, 343, 398, 379, 551, 554, 555, 557, 
   553, 1096, 1097, 1100, 1101, 1103, 1099, 1108, 1109, 1112, 1113, 1115, 1111, 1127, 1128, 1130, 
   1127, 1128, 1132, 1130, 1140, 1106, 1117, 1141, 1106, 1117, 1144, 1094, 1104, 1145, 1094, 1104, 
   1151, 1152, 1158, 1159, 1160, 1042, 1046, 1049, 1054, 1061, 1065, 1068, 1071, 1076, 1082, 1087, 
   1017, 1021, 1023, 1028, 1031, 1038, 981, 982, 986, 991, 1003, 1007, 1010, 972, 976, 939, 
   942, 948, 954, 960, 963, 966, 969, 911, 912, 916, 921, 922, 924, 931, 856, 861, 
   866, 871, 875, 884, 890, 895, 898, 905, 908, 801, 803, 810, 816, 826, 833, 842, 
   850, 776, 778, 780, 782, 783, 787, 794, 798, 759, 763, 767, 770, 720, 723, 731, 
   734, 738, 745, 748, 754, 684, 689, 694, 699, 704, 712, 715, 641, 644, 652, 658, 
   663, 669, 675, 678, 626, 631, 635, 559, 564, 570, 573, 583, 593, 596, 603, 609, 
   616, 400, 405, 411, 415, 419, 423, 429, 436, 441, 447, 452, 459, 465, 469, 476, 
   486, 496, 506, 518, 529, 535, 544, 235, 240, 243, 251, 255, 256, 262, 271, 272, 
   281, 282, 291, 296, 328, 363, 196, 200, 204, 211, 218, 225, 228, 168, 175, 176, 
   182, 189, 192, 69, 74, 76, 79, 86, 95, 106, 112, 122, 126, 131, 138, 142, 
   147, 152, 155, 162, 15, 16, 21, 23, 25, 56, 57, 60, 61, 66, 67, 1122, 
   1123, 1125, 1129, 1131, 1133, 1153, 1154, 1155, 1156, 1161, 1162, 
};
...
static final long[] jjtoToken = {
   0xfffffffffffff801L, 0xffffffffffffffffL, 0xffff08807fffffffL, 0xffffffffffffffffL, 
   0x67L, 
};
...
private final int[] jjrounds = new int[1163];
private final int[] jjstateSet = new int[2326];
