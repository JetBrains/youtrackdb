...
public class CoreWorkload extends Workload {
   ...
   */
  public static final String INSERTION_KEEP_GOING_ON_ERROR =
      "core_workload_insertion_keep_going_on_error";
  ...
  public boolean doInsert(DB db, Object threadstate) {
    ...
    do {
      ...
      if (++numOfRetries <= insertionRetryLimit) {
        ...
        System.err
            .println("Error inserting, not retrying any more. number of attempts: " + numOfRetries +
  ...
  public void doTransactionScan(DB db) {
    ...
    Vector<HashMap<String, ByteIterator>> scannedRecords =
        new Vector<HashMap<String, ByteIterator>>();
    long st = System.nanoTime();
    db.scan(table, startkeyname, len, fields, scannedRecords);
    long en = System.nanoTime();
    measurements.measure("SCAN-LATENCY-PER-RECORD",
        (int) ((en - st) / 1000 / scannedRecords.size()));
  }
