...
public final class YTDBVertexPropertyProperty<U> implements Property<U> {
    private final String key;
    private final U value;
    private final YTDBVertexProperty<?> source;
    private boolean removed = false;

    public YTDBVertexPropertyProperty(
            String key, U value, YTDBVertexProperty<?> ytdbVertexProperty) {
        this.key = key;
        this.value = value;
