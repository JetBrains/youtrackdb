/*
 * JUnit 4 version of DateTest.
 * Original: tests/src/test/java/com/jetbrains/youtrackdb/auto/DateTest.java
 *
...
public class DateTest extends BaseDBTest {
  ...
  private static DateTest instance;

  @BeforeClass
  public static void setUpClass() throws Exception {
    instance = new DateTest();
    instance.beforeClass();
  }

  /**
   * Original: beforeClass (line 0) Location:
   * tests/src/test/java/com/jetbrains/youtrackdb/auto/DateTest.java
   */
  @Override
  ...
  /**
   * Original: testDateConversion (line 31) Location:
   * tests/src/test/java/com/jetbrains/youtrackdb/auto/DateTest.java
   */
  @Test
  public void test01_DateConversion() {
  ...
  /**
   * Original: testDatePrecision (line 55) Location:
   * tests/src/test/java/com/jetbrains/youtrackdb/auto/DateTest.java
   */
  @Test
  public void test02_DatePrecision() {
    final var begin = System.currentTimeMillis();
  ...
  /**
   * Original: testDateTypes (line 82) Location:
   * tests/src/test/java/com/jetbrains/youtrackdb/auto/DateTest.java
   */
  @Test
  public void test03_DateTypes() {
    session.begin();
  ...
  /**
   * Original: testDateGregorianCalendar (line 97) Location:
   * tests/src/test/java/com/jetbrains/youtrackdb/auto/DateTest.java
   */
  @Test
  public void test04_DateGregorianCalendar() throws Exception {
