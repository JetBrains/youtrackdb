/*
 * JUnit 4 version of CollateTest.
 * Original: tests/src/test/java/com/jetbrains/youtrackdb/auto/CollateTest.java
 *
...
/**
 * JUnit 4 version of CollateTest. Original:
 * tests/src/test/java/com/jetbrains/youtrackdb/auto/CollateTest.java
 */
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class CollateTest extends BaseDBTest {

  private static CollateTest instance;

  @BeforeClass
  public static void setUpClass() throws Exception {
    instance = new CollateTest();
  ...
  /**
   * Original: testQuery (line 19) Location:
   * tests/src/test/java/com/jetbrains/youtrackdb/auto/CollateTest.java
   */
  @Test
  ...
  /**
   * Original: testQueryNotNullCi (line 66) Location:
   * tests/src/test/java/com/jetbrains/youtrackdb/auto/CollateTest.java
   */
  @Test
  public void test02_QueryNotNullCi() {
    final Schema schema = session.getMetadata().getSchema();
  ...
  /**
   * Original: testIndexQuery (line 90) Location:
   * tests/src/test/java/com/jetbrains/youtrackdb/auto/CollateTest.java
   */
  @Test
  public void test03_IndexQuery() {
    final Schema schema = session.getMetadata().getSchema();
  ...
  /**
   * Original: testIndexQueryCollateWasChanged (line 141) Location:
   * tests/src/test/java/com/jetbrains/youtrackdb/auto/CollateTest.java
   */
  @Test
  public void test04_IndexQueryCollateWasChanged() {
    final Schema schema = session.getMetadata().getSchema();
  ...
  /**
   * Original: testCompositeIndexQueryCS (line 187) Location:
   * tests/src/test/java/com/jetbrains/youtrackdb/auto/CollateTest.java
   */
  @Test
  public void test05_CompositeIndexQueryCS() {
    final Schema schema = session.getMetadata().getSchema();
  ...
  /**
   * Original: testCompositeIndexQueryCollateWasChanged (line 259) Location:
   * tests/src/test/java/com/jetbrains/youtrackdb/auto/CollateTest.java
   */
  @Test
  public void test06_CompositeIndexQueryCollateWasChanged() {
    final Schema schema = session.getMetadata().getSchema();
