...
| R-02 | should-fix | Add getVisibleStream() for multi-value get() optimization | `review-fix-02-multivalue-get-visible.md` | [x] DONE | 3cbd775b32 |
| R-03 | suggestion | Extract shared versioned put/remove into VersionedIndexOps | `review-fix-03-dry-doput.md` | [x] DONE | 191b393405 |
| R-04 | suggestion | Unify duplicated extractKey() into parameterized helper | `review-fix-04-dry-extract-key.md` | [x] DONE | 87ee250c6d |
| R-05 | suggestion | Initialize approximate count from TREE_SIZE on upgrade | `review-fix-05-upgrade-count-init.md` | [x] DONE | 6b51bc64a2 |
| R-06 | suggestion | Replace @Nullable Optional with two doPutSingleValue overloads | `review-fix-06-nullable-optional.md` | [x] DONE | a5387f147e |
| R-07 | suggestion | Add visibilityFilterValues() to avoid RawPair allocation | `review-fix-07-visibility-filter-values.md` | [x] DONE | a91ebeef44 |
| R-08 | suggestion | Recalibrate null count in multi-value buildInitialHistogram | `review-fix-08-null-count-recalibrate.md` | [x] DONE | 9e23b46d2a |
